...
local Coordenadas = {
    {-186.95,-1700.92,32.9}, -- -198.02,-1598.19,34.91 groove
    {80.39,-1902.71,21.69}, -- 84.3,-1966.68,20.94    ballas
    {290.22,-2031.28,19.77} -- 342.1,-2074.94,20.94 vagos
}
                    ...
                    if distance <= 1.2 then
                        ...
                        if IsControlJustPressed(0, 38)  then
                            if GetDistanceBetweenCoords(
                                GetEntityCoords(PlayerPedId()),-186.95,-1700.92,32.9, true) <= 1.2 then
                                servico = true
                                inicio = 1
                                fim = 20
                            ...
                            elseif GetDistanceBetweenCoords(
                                GetEntityCoords(PlayerPedId()),80.39,-1902.71,21.69, true) <= 1.2 then
                                servico = true
                                inicio = 1
                                fim = 20
                                selecionado = math.random(inicio, fim)
                                CriandoBlip(locs, selecionado)
                            elseif GetDistanceBetweenCoords(
                                GetEntityCoords(PlayerPedId()),290.22,-2031.28,19.77, true) <= 1.2 then
                                servico = true
                                inicio = 1
                                fim = 20
                                selecionado = math.random(inicio, fim)
...
Citizen.CreateThread(function()
    while true do
        ...
        if servico then
            ...
            drawTxt("VA ATE O ~y~DESTINO~w~ E ENTREGUE ~g~
                        5 ~w~ DROGAS.", 4, 0.2438, 0.956, 0.48, 255, 255, 255,
                    200)
        end
    end
end)
