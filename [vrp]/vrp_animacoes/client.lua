...
local animacoes = {
	...
	{ nome = "render" , dict = "random@arrests@busted" , anim = "idle_a" , andar = false , loop = true },
	{ nome = "render2" , dict = "random@arrests@busted" , anim = "idle_b" , andar = false , loop = true },
	{ nome = "render3" , dict = "random@arrests@busted" , anim = "idle_c" , andar = false , loop = true },
