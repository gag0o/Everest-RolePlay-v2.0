...
LSC_Config.prices = {
	...
	xenoncolor = {
		{ name = "White", xenon = 0, price = 3000 },
		{ name = "Blue", xenon = 1, price = 3000 },
		{ name = "Electric Blue", xenon = 2, price = 3000 },
		{ name = "Mint Green", xenon = 3, price = 3000 },
		{ name = "Lime Green", xenon = 4, price = 3000 },
		{ name = "Yellow", xenon = 5, price = 3000 },
		{ name = "Golden Shower", xenon = 6, price = 3000 },
		{ name = "Orange", xenon = 7, price = 3000 },
		{ name = "Red", xenon = 8, price = 3000 },
		{ name = "Pony Pink", xenon = 9, price = 3000 },
		{ name = "Hot Pink",xenon = 10, price = 3000 },
		{ name = "Purple", xenon = 11, price = 3000 },
		{ name = "Blacklight", xenon = 12, price = 3000 }
	},
	plates = {
	...
	wheelaccessories = {
		...
		{ name = "Custom Tires", price = 5000 },
		{ name = "White Tire Smoke", smokecolor = {254,254,254}, price = 2500 },
		{ name = "Black Tire Smoke", smokecolor = {1,1,1}, price = 2500 },
		{ name = "BLue Tire Smoke", smokecolor = {0,150,255}, price = 2500 },
		{ name = "Yellow Tire Smoke", smokecolor = {255,255,50}, price = 2500 },
		{ name = "Orange Tire Smoke", smokecolor = {255,153,51}, price = 2500 },
		{ name = "Red Tire Smoke", smokecolor = {255,10,10}, price = 2500 },
		{ name = "Green Tire Smoke", smokecolor = {10,255,10}, price = 2500 },
		{ name = "Purple Tire Smoke", smokecolor = {153,10,153}, price = 2500 },
		{ name = "Pink Tire Smoke", smokecolor = {255,102,178}, price = 2500 },
		{ name = "Gray Tire Smoke",smokecolor = {128,128,128}, price = 2500 }
	},
	wheelcolor = {
		colors = colors,
		price = 3000
	...
	sportwheels = {
		...
		{ name = "Inferno", wtype = 0, mod = 0, price = 5000 },
		{ name = "Deepfive", wtype = 0, mod = 1, price = 5000 },
		{ name = "Lozspeed", wtype = 0, mod = 2, price = 5000 },
		{ name = "Diamondcut", wtype = 0, mod = 3, price = 5000 },
		{ name = "Chrono", wtype = 0, mod = 4, price = 5000 },
		{ name = "Feroccirr", wtype = 0, mod = 5, price = 5000 },
		{ name = "Fiftynine", wtype = 0, mod = 6, price = 5000 },
		{ name = "Mercie", wtype = 0, mod = 7, price = 5000 },
		{ name = "Syntheticz", wtype = 0, mod = 8, price = 5000 },
		{ name = "Organictyped", wtype = 0, mod = 9, price = 5000 },
		{ name = "Endov1", wtype = 0, mod = 10, price = 5000 },
		{ name = "Duper7", wtype = 0, mod = 11, price = 5000 },
		{ name = "Uzer", wtype = 0, mod = 12, price = 5000 },
		{ name = "Groundride", wtype = 0, mod = 13, price = 5000 },
		{ name = "Spacer", wtype = 0, mod = 14, price = 5000 },
		{ name = "Venum", wtype = 0, mod = 15, price = 5000 },
		{ name = "Cosmo", wtype = 0, mod = 16, price = 5000 },
		{ name = "Dashvip", wtype = 0, mod = 17, price = 5000 },
		{ name = "Icekid", wtype = 0, mod = 18, price = 5000 },
		{ name = "Ruffeld", wtype = 0, mod = 19, price = 5000 },
		{ name = "Wangenmaster", wtype = 0, mod = 20, price = 5000 },
		{ name = "Superfive", wtype = 0, mod = 21, price = 5000 },
		{ name = "Endov2", wtype = 0, mod = 22, price = 5000 },
		{ name = "Slitsix", wtype = 0, mod = 23, price = 5000 }
	},
    importwheels = {
        { name = "Stock", wtype = 0, mod = -1, price = 1000 },
        { name = "Import01", wtype = 0, mod = 50, price = 7000 },
        { name = "Import02", wtype = 0, mod = 51, price = 7000 },
        { name = "Import03", wtype = 0, mod = 52, price = 7000 },
        { name = "Import04", wtype = 0, mod = 53, price = 7000 },
        { name = "Import05", wtype = 0, mod = 54, price = 7000 },
        { name = "Import06", wtype = 0, mod = 55, price = 7000 },
        { name = "Import07", wtype = 0, mod = 56, price = 7000 },
        { name = "Import08", wtype = 0, mod = 57, price = 7000 },
        { name = "Import09", wtype = 0, mod = 58, price = 7000 },
        { name = "Import10", wtype = 0, mod = 59, price = 7000 },
        { name = "Import11", wtype = 0, mod = 60, price = 7000 },
        { name = "Import12", wtype = 0, mod = 61, price = 7000 },
        { name = "Import13", wtype = 0, mod = 62, price = 7000 },
		{ name = "Import14", wtype = 0, mod = 63, price = 7000 },		
		{ name = "Import15", wtype = 0, mod = 64, price = 1000 },
        { name = "Import16", wtype = 0, mod = 65, price = 7000 },
        { name = "Import17", wtype = 0, mod = 66, price = 7000 },
        { name = "Import18", wtype = 0, mod = 67, price = 7000 },
        { name = "Import19", wtype = 0, mod = 68, price = 7000 },
        { name = "Import20", wtype = 0, mod = 69, price = 7000 },
        { name = "Import21", wtype = 0, mod = 70, price = 7000 },
        { name = "Import22", wtype = 0, mod = 71, price = 7000 },
        { name = "Import23", wtype = 0, mod = 72, price = 7000 },
        { name = "Import24", wtype = 0, mod = 73, price = 7000 },
        { name = "Import25", wtype = 0, mod = 74, price = 7000 },
        { name = "Import26", wtype = 0, mod = 75, price = 7000 },
        { name = "Import27", wtype = 0, mod = 76, price = 7000 },
        { name = "Import28", wtype = 0, mod = 77, price = 7000 },
		{ name = "Import29", wtype = 0, mod = 78, price = 7000 },
        { name = "Import30", wtype = 0, mod = 79, price = 7000 },
        { name = "Import31", wtype = 0, mod = 80, price = 7000 },
        { name = "Import32", wtype = 0, mod = 81, price = 7000 },
        { name = "Import33", wtype = 0, mod = 82, price = 7000 }
    },
	suvwheels = {
		{ name = "Stock", wtype = 3, mod = -1, price = 1000 },
		{ name = "Enercy", wtype = 3, mod = 0, price = 5000 },
	...
	highendwheels = {
		...
		{ name = "Shadow", wtype = 7, mod = 0, price = 5000 },
		{ name = "Hyper", wtype = 7, mod = 1, price = 5000 },
		{ name = "Blade", wtype = 7, mod = 2, price = 5000 },
		{ name = "Diamond", wtype = 7, mod = 3, price = 5000 },
		{ name = "Supagee", wtype = 7, mod = 4, price = 5000 },
		{ name = "Chromaticz", wtype = 7, mod = 5, price = 5000 },
		{ name = "Merciechlip", wtype = 7, mod = 6, price = 5000 },
		{ name = "Obeyrs", wtype = 7, mod = 7, price = 5000 },
		{ name = "Gtchrome", wtype = 7, mod = 8, price = 5000 },
		{ name = "Cheetahr", wtype = 7, mod = 9, price = 5000 },
		{ name = "Solar", wtype = 7, mod = 10, price = 5000 },
		{ name = "Splitten", wtype = 7, mod = 11, price = 5000 },
		{ name = "Dashvip", wtype = 7, mod = 12, price = 5000 },
		{ name = "Lozspeedten", wtype = 7, mod = 13, price = 5000 },
		{ name = "Carboninferno", wtype = 7, mod = 14, price = 5000 },
		{ name = "Carbonshadow", wtype = 7, mod = 15, price = 5000 },
		{ name = "Carbonz", wtype = 7, mod = 16, price = 5000 },
		{ name = "Carbonsolar", wtype = 7, mod = 17, price = 5000 },
		{ name = "Carboncheetahr", wtype = 7, mod = 18, price = 5000 },
		{ name = "Carbonsracer", wtype = 7, mod = 19, price = 5000 }
	},
	lowriderwheels = {
		{ name = "Stock", wtype = 2, mod = -1, price = 1000 },
		{ name = "Flare", wtype = 2, mod = 0, price = 5000 },
		{ name = "Wired", wtype = 2, mod = 1, price = 5000 },
		{ name = "Triplegolds", wtype = 2, mod = 2, price = 5000 },
		{ name = "Bigworm", wtype = 2, mod = 3, price = 5000 },
		{ name = "Sevenfives", wtype = 2, mod = 4, price = 5000 },
		{ name = "Splitsix", wtype = 2, mod = 5, price = 5000 },
		{ name = "Freshmesh", wtype = 2, mod = 6, price = 5000 },
		{ name = "Leadsled", wtype = 2, mod = 7, price = 5000 },
		{ name = "Turbine", wtype = 2, mod = 8, price = 5000 },
		{ name = "Superfin", wtype = 2, mod = 9, price = 5000 },
		{ name = "Classicrod", wtype = 2, mod = 10, price = 5000 },
		{ name = "Dollar", wtype = 2, mod = 11, price = 5000 },
		{ name = "Dukes", wtype = 2, mod = 12, price = 5000 },
		{ name = "Lowfive", wtype = 2, mod = 13, price = 5000 },
		{ name = "Gooch", wtype = 2, mod = 14, price = 5000 }
	},
	musclewheels = {
		{ name = "Stock", wtype = 1, mod = -1, price = 1000 },
		{ name = "Classicfive", wtype = 1, mod = 0, price = 5000 },
		{ name = "Dukes", wtype = 1, mod = 1, price = 5000 },
		{ name = "Musclefreak", wtype = 1, mod = 2, price = 5000 },
		{ name = "Kracka", wtype = 1, mod = 3, price = 5000 },
		{ name = "Azrea", wtype = 1, mod = 4, price = 5000 },
		{ name = "Mecha", wtype = 1, mod = 5, price = 5000 },
		{ name = "Blacktop", wtype = 1, mod = 6, price = 5000 },
		{ name = "Dragspl", wtype = 1, mod = 7, price = 5000 },
		{ name = "Revolver", wtype = 1, mod = 8, price = 5000 },
		{ name = "Classicrod", wtype = 1, mod = 9, price = 5000 },
		{ name = "Spooner", wtype = 1, mod = 10, price = 5000 },
		{ name = "Fivestar", wtype = 1, mod = 11, price = 5000 },
		{ name = "Oldschool", wtype = 1, mod = 12, price = 5000 },
		{ name = "Eljefe", wtype = 1, mod = 13, price = 5000 },
		{ name = "Dodman", wtype = 1, mod = 14, price = 5000 },
		{ name = "Sixgun", wtype = 1, mod = 15, price = 5000 },
		{ name = "Mercenary", wtype = 1, mod = 16, price = 5000 }
	},
	trim = {
		colors = colors,
		price = 3000
	...
	mods = {
		...
		[18] = {
			{ name = "None", mod = 0, price = 1000 },
			{ name = "Turbo", mod = 1, price = 10000 }
		},
		[16] = {
			{ name = "Blindagem 20%", modtype = 16, mod = 0, price = 25000 },
			{ name = "Blindagem 40%", modtype = 16, mod = 1, price = 50000 },
			{ name = "Blindagem 60%", modtype = 16, mod = 2, price = 75000 },
			{ name = "Blindagem 80%", modtype = 16, mod = 3, price = 100000 },
			{ name = "Blindagem 100%", modtype = 16, mod = 4, price = 125000 }
		},
		[15] = {
			{ name = "Lowered Suspension", mod = 0, price = 7500 },
			{ name = "Street Suspension", mod = 1, price = 10000 },
			{ name = "Sport Suspension", mod = 2, price = 20000 },
			{ name = "Race Suspension", mod = 3, price = 30000 }
		},
		[14] = {
			{ name = "Truck Horn", mod = 0, price = 2500 },
			{ name = "Police Horn", mod = 1, price = 5000 },
			...
			{ name = "Festive Loop 2", mod = 47, price = 2500 },
			{ name = "Festive Loop 3", mod = 48, price = 2500 }
		},
		[13] = {
			{ name = "Street Transmission", mod = 0, price = 20000 },
			{ name = "Sport Transmission", mod = 1, price = 30000 },
			{ name = "Race Transmission", mod = 2, price = 40000 }
		},
		[12] = {
			{ name = "Street Brakes", mod = 0, price = 15000 },
			{ name = "Sport Brakes", mod = 1, price = 25000 },
			{ name = "Race Brakes", mod = 2, price = 35000 }
		},
		[11] = {
			{ name = "Lowered Engine", mod = 0, price = 10000 },
			{ name = "Street Engine", mod = 1, price = 20000 },
			{ name = "Sports Engine", mod = 2, price = 30000 },
			{ name = "Race Engine", mod = 3, price = 40000 }
		},
		[10] = {
			startprice = 3000,
			increaseby = 0
