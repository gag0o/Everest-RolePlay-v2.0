...
local garages = {
	[1] = { locked = false, camera = { x = 935.21, y = -952.76, z = 40.75, heading = 224.13 }, driveout = { x = 944.79, y = -968.45, z = 39.75, heading = 182.15 }, drivein = { x = 945.70, y = -979.87, z = 39.75, heading = 2.24 }, outside = { x = 945.26, y = -976.01, z = 39.75, heading = 182.15 }, inside = { x = 945.03, y = -956.15, z = 39.12, heading = 3.04 }},
	[2] = { locked = false, camera = { x = 1177.98, y = 2636.05, z = 37.75, heading = 37.08 }, driveout = { x = 1175.00, y = 2642.17, z = 37.04, heading = 0.75 }, drivein = { x = 1174.70, y = 2643.76, z = 37.04, heading = 178.11 }, outside = { x = 1175.56, y = 2652.81, z = 37.94, heading = 351.57 }, inside = { x = 1174.82, y = 2637.80, z = 37.04, heading = 181.19 }},
	...
	[4] = { locked = false, camera = { x = -215.518, y = -1329.135, z = 30.89, heading = 329.092}, driveout = {x = -205.935, y = -1316.642, z = 30.176, heading = 356.495}, drivein = {x = -205.626,y = -1314.99, z = 30.247, heading = 179.395}, outside = {x = -205.594,y = -1304.085, z = 30.614, heading = 359.792}, inside = {x = -212.368,y = -1325.486, z = 30.176, heading = 141.107}},
	[5] = { locked = false, camera = { x = 1023.27, y = 3559.77, z = 36.88, heading = 37.08}, driveout = { x = 1023.36, y = 3564.15, z = 34.58, heading = 34,0 }, drivein = { x = 1023.36, y = 3564.15, z = 34.58, heading = 179.395}, outside = { x = 1022.85, y = 3569.5, z = 33.97, heading = 182.15}, inside = {x = 1023.34, y =3560.47, z = 33.98, heading = 141.107}}
}
										...
										if not LSC_Config.lock then
											if IsControlJustPressed(1,201) then
												if emP.checkPermission() then
													...
													TriggerEvent("Notify","negado","Apenas <b>mecânicos</b> podem modificar veículos.",8000)
												end
											else
												drawTxt("PRESSIONE  ~g~ENTER~w~  PARA ENTRAR NA ~y~MECÂNICA",4,0.5,0.93,0.50,255,255,255,180)
											end
										else
											drawTxt("~y~LOS SANTOS CUSTOMS~w~ OCUPADA NO MOMENTO",4,0.5,0.93,0.50,255,255,255,180)
										end
									else
										if IsControlJustPressed(1,201) then
											if emP.checkPermission() then
