...
-----------------------------------------------------------------------------------------------------------------------------------------
local valores = {
	{ item = "dourado", venda = 200 },
    { item = "corvina", venda = 100 },
    { item = "salmao", venda = 190 },
    { item = "pacu", venda = 100 },
    { item = "pintado", venda = 175},
    { item = "pirarucu", venda = 145 },
    { item = "tilapia", venda = 155 },
    { item = "tucunare", venda = 160 },
    { item = "lambari", venda = 290 }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- VENDER
-----------------------------------------------------------------------------------------------------------------------------------------
