...
func = Tunnel.getInterface("vrp_motoclub")
...
-----------------------------------------------------------------------------------------------------------------------------------------
local locais = {
    {x = 1001.25, y = -130.47, z = 74.07, type = "motoclub"},
    {x = 2002.76, y = 3047.23, z = 46.99, type = "motoclub"}
}
        ...
        for i, item in pairs(locais) do
            ...
            if distance <= 1 and not menuactive then
                ...
                if IsControlJustPressed(0, 38) then
                    if item.type == "motoclub" and func.checkPermission() then
...
RegisterNUICallback("ButtonClick", function(data, cb)
    if data == "fechar" then
        ...
        TriggerServerEvent("motoclub-comprar", data)
    end
end)

RegisterNetEvent('vrp_motoclub:fecharMenu')
AddEventHandler('vrp_motoclub:fecharMenu', function() ToggleActionMenu() end)

RegisterNetEvent('vrp_motoclub:animacao')
AddEventHandler('vrp_motoclub:animacao', function(isPlay)
    if isPlay then
