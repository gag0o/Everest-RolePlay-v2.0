...
local itemlist = {
	...
	[4] = { ['name'] = "Minério de Rubi", ['index'] = "rubi" },
	[5] = { ['name'] = "Ferro", ['index'] = "ferro" },
...
local itemlistMafia = {
	[1] = { ['name'] = "Ferro", ['index'] = "ferro", min=3, max=8 },
}

function emP.checkPermissionMafia()
	local source = source
	local user_id = vRP.getUserId(source)
	return vRP.hasPermission(user_id,"motoclub.permissao") or vRP.hasPermission(user_id,"mafia.permissao") or vRP.hasPermission(user_id,"motoclub2.permissao")
end
