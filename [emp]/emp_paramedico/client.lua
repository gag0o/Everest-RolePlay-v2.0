...
local CoordenadaX = 307.0
local CoordenadaY = -595.11
...
Citizen.CreateThread(function()
	while true do
		...
		if emservico then
			...
			if distance <= 50.0 and IsVehicleModel(vehicle,GetHashKey("paramedicoambu")) or IsVehicleModel(vehicle,GetHashKey("paramedicosilverado")) or IsVehicleModel(vehicle,GetHashKey("paramedicotahoe"))  or IsVehicleModel(vehicle,GetHashKey("paramedicocharger2014")) then
