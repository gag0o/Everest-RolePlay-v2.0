TokoVoipConfig = {
	...
	distance = {
		...
		25, -- Medium speech distance in gta distance units
	...
	plugin_data = {
		...
		-- Blocking screen informations 167.114.90.63:3000 - okcrp.shts3.top
		TSServer = "everestinfinity.ts3dns.eu", -- TeamSpeak server address to be displayed on blocking screen
		TSChannelSupport = "Suporte", -- TeamSpeak support channel name displayed on blocking screen
		TSDownload = "Qualquer duvidas de como baixar, acesse nosso discord: https://discord.gg/JRy6Acu", -- Download link displayed on blocking screen
