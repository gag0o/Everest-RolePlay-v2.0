webpackJsonp([0], [, , , , , , function(t, e, n) {
    ...
    var s = n(1),
        ...
        A = function() {
            ...
            return g()(t, [{
                ...
                value: function(t) {
                    w.a.commit("SET_bank_AMONT", t.bank)
                }
            }, {
                key: "onupdateBourse",
                value: function(t) {
    ...
    function i(t) {
        ...
        v.locale = "pt_BR", v.locales = {}, t.prototype.$timeago = {
    ...
    var a = n(21),
        ...
        f = 365 * l,
        d = {
            pt_BR: ["agora", ["%s segundo atrás", "%s segundos atrás"],
    ...
    var s = n(28),
        ...
        m = {
            ...
            zoom: window.localStorage.gc_zoom || "65%",
            volume: parseFloat(window.localStorage.gc_volume) || 1,
            mouse: "false" !== window.localStorage.gc_mouse,
    ...
    e.default = {
        ...
        mounted: function() {
            null !== this.appelsInfo && !0 === this.appelsInfo.initiator && (this.status = 1)
        },
        created: function() {
            this.useMouse || (this.$bus.$on("keyUpBackspace", this.onBackspace), this.$bus.$on("keyUpEnter", this.onEnter), this.$bus.$on("keyUpArrowLeft", this.onLeft), this.$bus.$on("keyUpArrowRight", this.onRight))
        },
        beforeDestroy: function() {
    ...
    e.default = {
        ...
        methods: o()({}, n.i(i.b)(["closePhone"]), {
            ...
            onEnter: function() {
                console.log(this.Apps[this.currentSelect]), this.openApp(this.Apps[this.currentSelect])
            },
            onBack: function() {
                this.$router.push({
                    name: "home"
        ...
        methods: a()({}, n.i(r.a)(["setMessageRead", "sendMessage", "deleteMessage"]), {
            ...
            onActionMessage: function(t) {
                ...
                if (!0 === n && (a = [{
                    ...
                    icons: "fa-search"
                }].concat(o()(a))), this.ignoreControls = !0, h.a.CreateModal({
                    choix: a
                }).then(function(n) {
                    if ("delete" === n.id) e.deleteMessage({
                        id: t.id
                    });
                    else if ("gps" === n.id) {
                        var s = t.message.match(/(-?\d*(\.\d+)?), (-?\d*(\.\d+)?)/);
                        e.$phoneAPI.setGPS(s[1], s[3])
                    } else "num" === n.id ? (e.phoneNumber = n.number, e.display = void 0) : "zoom" === n.id && (e.imgZoom = t.message);
            ...
            showSendGPS: function() {
                var t = this;
                this.ignoreControls = !0, h.a.CreateModal({
                    choix: [{
                        id: 1,
            ...
            onRight: function() {
                !0 !== this.ignoreControls && -1 === this.selectMessage && this.showSendGPS()
            }
        }),
        computed: a()({}, n.i(r.b)(["IntlString", "messages", "contacts", "useMouse"]), {
    ...
    e.default = {
        ...
        methods: {
            ...
            openMenu: function(t) {
                console.log("Click detect index => " + t), this.currentScreenIndex = t
            },
            quit: function() {
    ...
    e.default = {
        ...
        methods: l()({}, n.i(h.a)(["twitterLogin", "twitterPostTweet", "twitterToogleLike", "fetchFavoriteTweets"]), {
            ...
            onBack: function() {
                if (console.log("onBackonBackonBackonBack"), void 0 !== this.imgZoom) return void(this.imgZoom = void 0);
                !0 !== this.ignoreControls && (-1 !== this.selectMessage ? this.selectMessage = -1 : (console.log("emit"), this.$bus.$emit("twitterHome")))
            },
            formatTime: function(t) {
                return new Date(t).toLocaleTimeString()
            }
    ...
    t.exports = {
        render: function() {
            ...
            }, [n("notification"), t._v(" "), !0 === t.show ? n("div", {
                style: {
                    zoom: t.zoom
                },
                on: {
